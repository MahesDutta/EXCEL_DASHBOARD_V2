...
function MapCard({ rows, title = "Location map" }) {
  ...
  // Use a categorical palette so neighbouring states are visibly different.
  // Count still controls the legend order, while colour identifies the state.
  const MAP_PALETTE = [
    "#2563EB", "#DC2626", "#16A34A", "#9333EA", "#EA580C",
    "#0891B2", "#CA8A04", "#DB2777", "#4F46E5", "#65A30D",
    "#0D9488", "#C026D3", "#7C3AED", "#0284C7", "#E11D48",
    "#15803D", "#B45309", "#4338CA", "#BE123C", "#047857"
  ];
  ...
  return <ChartCard wide title={title} subtitle={`Detected ${matchedStates.length} place${matchedStates.length === 1 ? "" : "s"} in the worksheet. Each detected state gets its own colour; the list is ranked by occurrence count.`}>
